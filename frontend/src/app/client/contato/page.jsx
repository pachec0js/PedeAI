    ...
    <>
      ...
      <section className="contatoSection">
        <div className="container py-5">
          <div className="row informs">
            {/* Bloco esquerdo */}
            <div className="col-md-6 mb-4 location">
              <div className="row cardBox">
                ...
                <div className="col-md-5 cardItem">
                  ...
                  <h5>Localização</h5>
                  <p>Av. Pereira Barreto, 400 - Baeta Neves, SBC - SP</p>
                </div>
              </div>
              {/* Mapa */}
              <div className="mapa mt-4">
                <iframe
                  title="Google Maps"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d233801.56034890926!2d-46.67055991318284!3d-23.706358997736697!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce4230e86e2165%3A0xa945f637af54fea3!2sEscola%20T%C3%A9cnica%20Estadual%20Lauro%20Gomes!5e0!3m2!1spt-BR!2sbr!4v1749602819620!5m2!1spt-BR!2sbr" 
                  width="100%"
                  height="200"
                  style={{ border: 0 }}
                  allowFullScreen=""
            ...
            <div className="col-md-6 questions">
              ...
              <form className="form">
                ...
                <div className="col-md-12 submitquestions">
            ...
            <div className="d-flex flex-wrap mt-5">
              ...
              <div className="col-md-7 col-12">
                <h1 className="duvida title fw-bold bi bi-question-circle-fill me-2">
                   {' '}
                      Dúvidas frequentes
                </h1>
                <h4 className="subtitle">Confira se sua dúvida já foi respondida!</h4>

                {loadingFaq && <div className="d-flex justify-content-center align-items-center" style={{ height: '80vh' }}>
