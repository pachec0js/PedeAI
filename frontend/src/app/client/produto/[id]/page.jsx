  ...
  useEffect(() => {
    connectBack
      ...
      .then((res) => {
        ...
        return connectBack.get(`/produtos/sabores/${produtoData.nome_cardapio}`);
      })
      .then((res) => {
        setSabores(res.data);
    ...
    <div className="container produto-page">
      <div className="row mb-5">
        ...
        <div className="col-md-6">
          ...
          <button className="btn-add-carrinho mt-4" onClick={adicionarAoCarrinho}>
        ...
        <div className="col-md-6 text-center align-items-center d-flex flex-column">
            ...
            <>
              ...
              <div className="sabores">
                {sabores.map((s) => (
                  <div
                    key={s.id}
                    className={`sabor ${s.sabor === saborSelecionado ? 'ativo' : ''}`}
                    onClick={() => setSaborSelecionado(s.sabor)}
                  >
                    <img
                      src={`/imgs/opcoes/${formatarNome(produto.nome_cardapio) + formatarNome(s.sabor)}.png`}
                      alt={s.sabor}
                    />
                    <p>{s.sabor}</p>
                  </div>
          ...
          <h3 className="title-personaliza mt-4 mb-2">Personalize seu produto</h3>
          <p className="texto-secundario">Escreva aqui algo que você queira remover do produto</p>
          <textarea
      ...
      <div className="mb-5">
        ...
        <p className="texto-secundario">Desfrute das melhores combinações feitas pra você</p>
